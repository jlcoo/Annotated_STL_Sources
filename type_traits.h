...
struct __type_traits { 
   typedef __true_type     this_dummy_member_must_be_first;  //不要移除这个成员
   ...
   /* The following restrictions should be observed for the sake of
      ...
      of this class:
          ...
          - You must not rename members without making the corresponding
            name change in the compiler 不能以下成员重命名而却没有在编译器中加上适当的支�?          - Members you add will be treated like regular members unless新加的成员会被视为一个一般成�?            you add the appropriate support in the compiler. */
...
template <class _Tp>    //对原始指针设计的__type_traits偏特化版本，原生指针被视为一种标量类�?struct __type_traits<_Tp*> {
   typedef __true_type    has_trivial_default_constructor;
   typedef __true_type    has_trivial_copy_constructor;
   typedef __true_type    has_trivial_assignment_operator;
   typedef __true_type    has_trivial_destructor;
